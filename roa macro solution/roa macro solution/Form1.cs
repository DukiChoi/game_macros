    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            do
            {
                ...
                if (ini_read_yubu == "시작시각" && ini_read_key != "Right" && ini_read_key != "Left" && ini_read_key != "Up" && ini_read_key != "Down" && ini_read_key != "Space")
                {
                ...
                //점프키 눌러주는 구문 두개
                else if (ini_read_yubu == "시작시각" && ini_read_key == "Space" && ini_read_key_before == "Right" | ini_read_key_before == "Left" | ini_read_key_before == "Down" | ini_read_key_before == "Space")
                {
                    mykey = typeof(Form1).GetField("DIK_SPACE");
                    Key2 = Convert.ToUInt16(mykey.GetValue(null));
                ...
                else if (ini_read_yubu == "시작시각" && ini_read_key == "Space" && ini_read_key_before != "Right" && ini_read_key_before != "Left" && ini_read_key_before != "Down" || ini_read_yubu == "시작시각" && ini_read_key == "Space" && ini_read_key_before == "")
                {
